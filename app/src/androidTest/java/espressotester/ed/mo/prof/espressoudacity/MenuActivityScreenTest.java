...
public class MenuActivityScreenTest extends Activity {

    public static final String TEA_NAME = "Green Tea";

    // TODO (2) Add the rule that provides functional testing of a single activity
    @Rule
    public ActivityTestRule<MenuActivityScreenTest> mActivityTestRule
            = new ActivityTestRule<>(MenuActivityScreenTest.class);
